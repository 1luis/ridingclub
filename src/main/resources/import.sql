...
--
INSERT INTO PAYMENTS (YEAR, MEMBERTYPE, AMOUNT, STATUS, MEMBER_ID) VALUES (2015, 'VOLLMITGLIED', 25, 'offen', 1);
INSERT INTO PAYMENTS (YEAR, MEMBERTYPE, AMOUNT, STATUS, MEMBER_ID) VALUES (2015, 'FOERDERMITGLIED', 10, 'bezahlt', '2');
--INSERT INTO PAYMENTS (YEAR, MEMBERTYPE, AMOUNT, STATUS, MEMBER_ID) VALUES (2015, 'JUGENDMITGLIED', 15, 'offen', 3);
INSERT INTO PAYMENTS (YEAR, MEMBERTYPE, AMOUNT, STATUS, MEMBER_ID) VALUES (2015, 'Vollmitglied', (SELECT amount FROM membertype WHERE name = 'Vollmitglied'), 'offen', 3);
